...
2. 邀请新用户可得💎1000DBC，新用户首周DBC使用量达1000DBC, 邀请奖励追加💎2000DBC，海外用户奖励翻倍
...
- [💫 宣传参考图](#-宣传参考图)
# 🕹 管理员介绍
- 宣传管理员（微信号：DBC-Lee，微信昵称：DBC / QQ号：191279367，Q群昵称：宣传管理）：审核/发放DBC奖励
- 技术管理员（微信号：fengbs600220，微信昵称：deepbrainfeng / QQ号：313785443，Q群昵称：技术管理）：技术售后
...
- ![](resource/r12.png)
- ![](resource/r25.png)
13. 完成绑定后打开收到的邮件并截图，填写推荐人地址(谁推荐的就填写Ta的地址，没人推荐的话就跳过)，到[群（点这里加群）](#-AI-Power)里发送消息并`@宣传管理`
...
- ![](resource/r31.png)
  ...
  * 上面的截图只是个例子，所以和前面截图的钱包地址不一样，你的截图应该跟前面是一样的
  ```
