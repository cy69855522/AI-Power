...
## 🎉 常规活动
- 注：DBC指算力积分，2.4kDBC约等于10元(随时间浮动)，可用于租用算力
...
6. 复制私钥，点击完成
- ![](resource/r5.png)
7. 到此账号已注册完毕，接下来可以领取新人奖励。注意一下自己的钱包地址（之后充值后领取奖励会用到），然后点击“如何购买DBC”（若担心隐私可通过转账方式跳过充值）
- ![](resource/r7.png)
...
- 2020/4/13日 🏹 单日排行榜：
  ...
  |AcooT...|1|
  |Ac1pK...|1|
  - `更新时间：2020/4/13 17:57，如有遗漏请联系群主修改`
