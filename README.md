...
- 补贴方式: 先充值1000DBC, 送1000DBC, 一周内用完2000DBC, 送剩余2000DBC; 如果没用完按照实际用的比例返还, 比如一周内用了1000DBC, 送1000DBC;

2、推荐用户奖励:奖励由每人2400DBC提高到3000DBC
- 奖励方式: 先奖励1000BC, 被邀请用户一周内用完2000DBC, 送剩余2000DBC; 如果没用完按照实际用的比例返还, 比如一周内用了1000DBC, 送1000DBC;
...
- ![](resource/r7.png)
8. 选择第一个，用支付宝充值（绑定邮箱需要账户内至少拥有1个DBC，不足0.01元，如果担心可以让你的邀请人赠送1DBC，这样就可以跳过充值步骤直接到第11步。注意：如果没有支付宝充值入口，请先切换语言为中文）
- ![](resource/r8.png)
